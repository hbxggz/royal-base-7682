...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-base-7682
```

A live public deployment of this template is available at [https://royal-base-7682.templates.workers.dev](https://royal-base-7682.templates.workers.dev)
